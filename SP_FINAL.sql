...
-- 🔹 Procedure de Login (El de tu amiga)
DELIMITER $$
CREATE PROCEDURE sp_login_usuario(
    IN p_correo_electronico VARCHAR(50), -- Cambiado de 'usuario' a 'correo'
    IN p_contrasena VARCHAR(255)
)
BEGIN
    SELECT 
    ...
    WHERE u.correo_electronico = p_correo_electronico -- Compara con correo
      AND u.contrasena = p_contrasena             -- Compara contraseña (inseguro)
      AND u.estatus = 1;
END $$
DELIMITER ;
...
SELECT 
    ...
    c.COLUMN_COMMENT AS 'Descripción',
    CASE 
